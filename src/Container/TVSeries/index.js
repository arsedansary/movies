...
import CardMoviesComponents from "../../Component/CardMovies";
import PaginationComponent from "../../Component/Pagination"; 

import LeftListBarComponent from '../../Component/LeftListBar';
            ...
            <Container>
                <Row>
                    <Col className='col-12'>
                        <section>
                            <h1 className='txtCenter'>Top Review TV Series </h1>
                            <h3 className='txtCenter'>TV Series For ARIYA</h3>
                        </section>
                    </Col>
                </Row> 
                <Row>
